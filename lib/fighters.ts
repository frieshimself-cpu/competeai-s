...
export const FIGHTERS: Record<string, Fighter> = {
  ...
  TOPURIA: F("TOPURIA", "Ilia Topuria", "TOP", "🇬🇪", "Georgia/Spain", "16-0-0", 96, 0.7, "El Matador"),
  GAETHJE: F("GAETHJE", "Justin Gaethje", "GAE", "🇺🇸", "USA", "26-5-0", 88, 0.85, "The Highlight"),
  ...
  OMALLEY: F("OMALLEY", "Sean O'Malley", "OMA", "🇺🇸", "USA", "18-2-0", 86, 0.75, "Suga"),
  ZAHABI: F("ZAHABI", "Aiemann Zahabi", "ZAH", "🇨🇦", "Canada", "13-2-0", 75, 0.5),
  LEWIS: F("LEWIS", "Derrick Lewis", "LEW", "🇺🇸", "USA", "28-12-0", 74, 0.95, "The Black Beast"),
  HOKIT: F("HOKIT", "Josh Hokit", "HOK", "🇺🇸", "USA", "5-1-0", 66, 0.6),
  CHANDLER: F("CHANDLER", "Michael Chandler", "CHA", "🇺🇸", "USA", "24-9-0", 83, 0.7, "Iron"),
  ...
  DLOPES: F("DLOPES", "Diego Lopes", "LOP", "🇲🇽", "Mexico", "26-7-0", 87, 0.55, "The Brazilian"),
